        ...
        <div className="w-full max-w-4xl mx-auto px-mobile-safe pt-8 pb-20">
          ...
          <header className="border-b-2 border-nepal-red pb-4 mb-8">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 font-nepali-serif leading-tight">
              {page?.title || "Terms of Service (सेवाका सर्तहरू)"}
            </h1>
          </header>
          ...
          {page?.content ? (
            ...
            <div className="text-gray-700 leading-relaxed font-mukta text-lg space-y-4">
              <p>
                Welcome to KTM Post. By accessing or using our news portal, you agree to comply with and be bound by the following terms and conditions of use.
              </p>
              <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-2">
                Intellectual Property
              </h2>
              <p>
                All articles, photos, graphics, and video contents on KTM Post are the copyrighted property of Digi Vision Pvt. Ltd. and KTM Post unless otherwise indicated. Unauthorized reproduction without explicit citation or permission is prohibited.
              </p>
            </div>
          )}
        </div>
